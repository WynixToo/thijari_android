...
//                lastLocation = locationmanager.getLastKnownLocation(LocationManager.NETWORK_PROVIDER);
    ...
    public void addMarker(BranchInformation location) {
        System.out.println("%%%%% BranchInformation.location = "+location);
        LatLng branchLocation = getLocationFromAddress(location.getAddress());
        System.out.println("%%%%% branchLocation = "+branchLocation);
        System.out.println("%%%%% branchLocation.latitude = "+branchLocation.latitude);
        System.out.println("%%%%% branchLocation.longitude = "+branchLocation.longitude);
        Location mLocation = new Location("");
        mLocation.setLatitude(branchLocation.latitude);
        mLocation.setLongitude(branchLocation.longitude);
